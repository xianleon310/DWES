...
#Se generan a través del comando "python3 manage.py inspectdb > webserviceapp/models.py"
#y los recoge, ya que desde settings, en databases busca la base de datos e inicia en __init__.py con el comando que se ve allí
